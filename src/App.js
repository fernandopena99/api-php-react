...
function App() {
  ...
  const seleccionarFramework=(framework, caso)=>{
    ...
    (caso==="Editar")? //OPERACION TERNARIA
    abrirCerrarModalEditar():
    abrirCerrarModalEliminar()
      ...
      <Modal isOpen={modalInsertar}>
            ...
            <ModalBody>
              <div className="form-group">
                ...
                <br/>
                <input type="text" className="form-control" name="lanzamiento" onChange={handleChange}></input>
                <br/>
                <label>Desarrollador: </label>
                <br/>
                <input type="text" className="form-control" name="desarrollador" onChange={handleChange}></input>
                <br/>
              </div>
            </ModalBody>
            <ModalFooter>
      ...
      <Modal isOpen={modalEditar}>
            ...
            <ModalBody>
              <div className="form-group">
                <label>Nombre: </label>
                <br/>
                <input type="text" className="form-control" name="nombre" onChange={handleChange} value={frameworkSeleccionado && frameworkSeleccionado.nombre}></input>
                <br/>
                <label>Lanzamiento: </label>
                <br/>
                <input type="text" className="form-control" name="lanzamiento" onChange={handleChange} value={frameworkSeleccionado && frameworkSeleccionado.lanzamiento}></input>
                <br/>
                <label>Desarrollador: </label>
                <br/>
                <input type="text" className="form-control" name="desarrollador" onChange={handleChange} value={frameworkSeleccionado && frameworkSeleccionado.desarrollador}></input>
                <br/>
              </div>
            </ModalBody>
            <ModalFooter>
